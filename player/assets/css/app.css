<!doctype html><html lang="en"><head><script>function gpxGetCookieKeys () {
            ...
            if(policyExcludedSid.indexOf(getParameterByName('sid')) == -1){
				...
				// }
				var iubendaSyncStubScript = document.querySelector("script[src='//cs.iubenda.com/sync/1944774.js']") ? document.querySelector("script[src='//cs.iubenda.com/sync/1944774.js']") : document.createElement('script');
				iubendaSyncStubScript.setAttribute('src', '//cs.iubenda.com/sync/1944774.js');
				iubendaSyncStubScript.setAttribute('type', 'text/javascript');
				document.head.appendChild(iubendaSyncStubScript);
				...
				var iubendaCcpaStubScript = document.querySelector("script[src='//cdn.iubenda.com/cs/gpp/stub.js']") ? document.querySelector("script[src='//cdn.iubenda.com/cs/gpp/stub.js']") : document.createElement('script');
				iubendaCcpaStubScript.setAttribute('src', '//cdn.iubenda.com/cs/gpp/stub.js');
            ...
            document.getElementsByTagName("head")[0].appendChild(colorStyle);</script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
				new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
			j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
			'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
		})(window,document,'script','dataLayerGPX','GTM-K7CPNRZ');</script><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="website" content="classroom6x.gitlab.io" /><meta name="viewport" content="height=device-height,initial-scale=1,width=device-width,maximum-scale=1,user-scalable=no,minimal-ui,viewport-fit=cover"><meta name="mobile-web-app-capable" content="yes"><script async src="https://securepubads.g.doubleclick.net/tag/js/gpt.js"></script><script>// Create Google tag
            window.googletag = {};
